...
- [x] Scaffold a React + TypeScript + Vite application foundation for FORGE
...
- Built a single-surface FORGE workspace with seeded project context, persisted layout state, contextual agent chat, visible specialist ownership, task flow, prompt staging, terminal trace, activity history, voice capture, and local-only provider preferences.
